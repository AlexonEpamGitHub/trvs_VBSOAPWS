...
// Configure SOAP endpoint with proper SoapCore 1.1.0.45 syntax for .NET 8
app.UseSoapEndpoint<IGetDataService>("/GetDataService.asmx", new BasicHttpBinding(), SoapSerializer.XmlSerializer);
